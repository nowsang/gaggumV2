...
bool pubsub_cpp__msg__my_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "pubsub_cpp.msg._my_msg.MyMsg",
        full_classname_dest, 28) == 0);
  }
  pubsub_cpp__msg__MyMsg * ros_message = _ros_message;
  {  // num
...
PyObject * pubsub_cpp__msg__my_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pubsub_cpp.msg._my_msg");
