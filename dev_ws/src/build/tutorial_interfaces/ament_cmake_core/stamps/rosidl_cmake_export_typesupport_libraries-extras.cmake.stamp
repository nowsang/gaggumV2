...
set(_exported_typesupport_libraries
  "__rosidl_typesupport_connext_c:tutorial_interfaces__rosidl_typesupport_connext_c;__rosidl_typesupport_connext_cpp:tutorial_interfaces__rosidl_typesupport_connext_cpp;__rosidl_typesupport_opensplice_c:tutorial_interfaces__rosidl_typesupport_opensplice_c;__rosidl_typesupport_opensplice_cpp:tutorial_interfaces__rosidl_typesupport_opensplice_cpp")
  ...
  foreach(_tuple ${_exported_typesupport_libraries})
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      if(NOT _lib)
        ...
        message(FATAL_ERROR "Package 'tutorial_interfaces' exports the typesupport library '${_library}' which couldn't be found")
      elseif(NOT IS_ABSOLUTE "${_lib}")
        # the found library must be an absolute path
        message(FATAL_ERROR "Package 'tutorial_interfaces' found the typesupport library '${_library}' at '${_lib}' which is not an absolute path")
