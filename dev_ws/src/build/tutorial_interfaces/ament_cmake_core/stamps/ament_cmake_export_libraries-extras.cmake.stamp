...
set(_exported_libraries "tutorial_interfaces__rosidl_typesupport_c;tutorial_interfaces__rosidl_typesupport_cpp;tutorial_interfaces__rosidl_generator_c;tutorial_interfaces__rosidl_typesupport_fastrtps_c;tutorial_interfaces__rosidl_typesupport_fastrtps_cpp;tutorial_interfaces__rosidl_typesupport_introspection_c;tutorial_interfaces__rosidl_typesupport_introspection_cpp")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'tutorial_interfaces' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND tutorial_interfaces_LIBRARIES ${_cfg} "${_lib}")
